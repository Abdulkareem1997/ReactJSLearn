...
const SwitchComponent: React.FC<props> = ({ onChangeSwitch, checked, disabled, beforeLabel, afterLabel }) => {
    const [checkedStatus, setCheckedStatus] = React.useState(checked);

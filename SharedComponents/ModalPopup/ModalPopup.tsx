...
const ModalPopup: FC<Props> = ({  open,clickHandler,onClose }) => {
                    ...
                    <div className={styles.modalPopupBgSect}>
                        ...
                        <div className={styles.modalPopupBgSectCont}>
                            ...
                            <div className='d-flex mt-3' style={{gap: "20px"}}>
                                ...
                                <ButtonComponent icon={''} image={""} textColor ="#1B1C1E" backgroundColor="#01B58A" disabled={false} buttonSize="Medium" type="outlined" onClick={() => {navigate('/assess')}} label="Continue Without Saving" minWidth="220" />
                            </div>
                        </div>                        
                    </div>
                </div>                    

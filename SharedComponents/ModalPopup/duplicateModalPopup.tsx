                    ...
                    <div className={styles.modalPopupBgSect}>
                        ...
                        <div className={styles.modalPopupBgSectCont}>
                            ...
                            <div className='d-flex mt-3' style={{gap: "20px"}}>
                                ...
                                <ButtonComponent icon={''} image={""} textColor ="#1B1C1E" backgroundColor="#9A9A9A" disabled={false} buttonSize="Medium" type="outlined" onClick={() => {navigate('/assess')}} label="Discard and Exit" minWidth="220" />
                            </div>
                        </div>                        
                    </div>
                </div>                    

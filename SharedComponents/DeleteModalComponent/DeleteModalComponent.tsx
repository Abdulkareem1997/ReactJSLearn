...
const DeleteModalComponent: React.FC<Props> = ({ open, onClose,descriptionText,title,deleteHandler}) => {
      ...
      >
        <div className="deleteModalPopoverBody">
          <div className="deleteModalPopoverBodyPadd">
            ...
            <ButtonComponent icon={""} image={""} textColor ="#fff" backgroundColor="#F95843" disabled={false} buttonSize="Large" type="contained" onClick={handleDeleteClick} label="Delete" minWidth="200" />
